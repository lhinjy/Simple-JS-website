  ...
  fetch('/api/pokemons')
    ...
    .then((pokemons) => {
      ...
      pokemons.forEach((pokemon) => {
        ...
        item.className =
          'col-span-1 flex flex-col text-center bg-white rounded-lg shadow divide-y divide-gray-200 animate-pulse';
        item.innerHTML = `
          <div class="flex-1 flex flex-col p-8">
            <img class="w-32 h-32 flex-shrink-0 mx-auto bg-gray-200 rounded-full" src="${pokemon.image}"/>
